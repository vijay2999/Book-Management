...
// const deletereviewe= async function(req,res){

  
// let bookId= req.params.bookId
// let revewe= req.params.revewe

// const reveiwedetails= await revieweModel.findById(revewe)

// const abs = reveiwedetails.bookId
// //if(bookId!==reveiwedetails.bookId)

// const bookwedetails= await bookweModel.findById(bookId)

// const reviwedelet= await reveiweModel.findOneAndUpdate({_id:revewe},{isdeleted:true}


// const bookdelet= await bookModel.findOneAndUpdate({_id:bookId},{$inc{isdeleted:true}
